...
The technical details are summarised below.
...
Open `src/ebike_UB_2.mdl` in Simulink; `src/run_sim.m` configures the constants and the track and runs the simulation.
